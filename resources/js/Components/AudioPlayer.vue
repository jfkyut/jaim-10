...
<template>
    <div class="bg-white dark:bg-zinc-800 shadow-lg rounded-lg p-3 border dark:border-zinc-700 w-full max-w-2xl mx-auto">
        ...
        <div class="flex justify-between items-center relative">
            ...
            <button @click="handleClose" class="absolute -top-1 -right-1 flex items-center justify-center w-5 h-5 rounded-full bg-zinc-200 dark:bg-zinc-700 hover:bg-zinc-300 dark:hover:bg-zinc-600 text-zinc-600 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200 transition-colors flex-shrink-0">
